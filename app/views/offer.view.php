          ...
          <div class="contact-card">
            ...
            <h3><?php echo $offre['full_name'] ?></< /h3>
              ...
              <form action="/annonce/report" method="post">
                <input type="hidden" name="type_annonce" value="<?= $offre['announce_type'] ?>">
                <input type="hidden" name="report" value="<?= $offre['is_reported'] == 0 ? 1 : 1; ?>">
                <input type="hidden" name="id_announce" value="<?= $offre['announce_id'] ?>">
