    ...
    <div class="property-container">
      <?php foreach ($demandes as $demande) : ?>
        ...
        <div class="contact-card">
          ...
          <form action="/annonce/report" method="post">
            <input type="hidden" name="type_annonce" value="<?= $demande['announce_type'] ?>">
            <input type="hidden" name="report" value="<?= $demande['is_reported'] == 0 ? 1 : 1; ?>">
            <input type="hidden" name="id_announce" value="<?= $demande['announce_id'] ?>">
            <button name="btn_report" style="background-color: transparent ; border:none;">
