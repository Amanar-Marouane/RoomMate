...
<header
    ...
    <div class='flex flex-wrap items-center justify-between gap-5 w-full'>
        <a href="/home" class="max-sm:hidden text-indigo-500 font-bold text-2xl">Roomate</a>
        <a href="/home" class="hidden max-sm:block text-indigo-500 font-bold text-2xl">Roomate</a>

        <div id="collapseMenu"
            class='max-lg:hidden lg:!block max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50'>
            <button id="toggleClose"
                class='lg:hidden fixed top-2 right-4 z-[100] rounded-lg bg-white w-9 h-9 flex items-center justify-center border'>
        ...
        <!-- <button
                    class='px-4 py-2 text-sm rounded-lg font-bold text-blue-500 border-2 border-blue-500 bg-white transition-all ease-in-out duration-300 hover:bg-blue-500 hover:text-white hover:border-white'>
                    Login
                </button>
                <button
                    class='px-4 py-2 text-sm rounded-lg font-bold text-white border-2 border-white bg-blue-500 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-blue-500 hover:border-blue-500'>
