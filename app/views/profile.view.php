                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h3 class="font-medium text-gray-900">Youssoufia</h3>
                                        <p class="text-gray-500 text-sm">Available from November 5</p>
                                    </div>
                                    <span class="bg-indigo-100 text-indigo-800 text-xs font-medium px-2.5 py-0.5 rounded-full">800 DH</span>
                                </div>
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors">
                                <div class="flex justify-between items-start">
                                    ...
                                    <span class="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded-full">800 DH</span>
                                </div>
                                <div class="flex gap-2 mt-4">
                                    <button class="text-gray-400 hover:text-indigo-600">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
