                        ...
                        <tr class="h-20">
                            ...
                            <td class="p-4">
                                <div>
                                    ...
                                    <button
                                        class="text-sm text-orange-600 font-bold bg-orange-200 bg-opacity-50 py-1 px-1.5 border-0 rounded-full">Desactive</button>
                            ...
                            <td class="p-4">
                                <div>
                                    ...
                                    <form method="post" action="" class="text-sm text-blue-600 font-bold flex pt-1">
                    ...
                    <tr class="h-20">
                        <td class="p-4">
                            <div class="flex justify-start items-center gap-0.5">
                                ...
                                <div>
                                    <p class="text-sm text-blue-600 font-bold">full name</p>
                                    <p class="text-sm text-blue-500 ">origin city</p>
                                </div>
                            </div>
                        </td>
                        <td class="p-4">
                            <div>
                                <p class="text-sm text-blue-500 opacity-50">Compus</p>
                                <p class="text-sm text-blue-600 font-bold">origin city</p>
                            </div>
                        </td>
                        <td class="p-4">
                            <div>
                        ...
                        <td class="p-4">
                            <div>
                                <p class="text-sm text-blue-500 opacity-50">Status</p>
                                <button
                                    class="text-sm text-blue-600 font-bold bg-blue-200 bg-opacity-50 py-1 px-1.5 border-0 rounded-full">Active</button>
                            </div>
                        </td>
                        <td class="p-4">
                            <div>
