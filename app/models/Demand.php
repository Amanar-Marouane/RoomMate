...
use app\models\Announce;
 ...
 class Demand extends Announce {
    ...
    public function __construct($type="",$localisation="", $address="", $description="", $budget=0, $available_at=null, 
                                $zones_souhaitees="", $demand_type="", $move_in_date=null) {
...
$this->available_at,$this->announce_type,$this->budget,$this->zones_souhaitees,
$this->demand_type,$this->move_in_date];
$db = $this->pdo;
